...
class Encoder(nn.Module):#一个GIMA
    def __init__(self, d_emb_1, d_emb_2, n_layers, d_inner, n_head, d_k=None, d_v=None, dropout=0.1, n_position=2048, add_sa=False):
        ...
        self.position_enc1 = PositionEncoding(d_emb_1, n_position=n_position)#位置编码d_emb_1序列长度，n_position最大的编码维度
        ...
        if not add_sa:
            self.layer_stack1 = nn.ModuleList([ #一个GIMA
...
# seq1= torch.Size([16, 21, 74])
# seq2= torch.Size([16, 21, 35])
